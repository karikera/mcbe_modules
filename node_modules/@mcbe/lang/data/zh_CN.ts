...
const lang_data = {
    ...
    commands:{
        ...
        "code_description": "启动代码生成器。",
        "code_success": "已启动代码生成器。",
        ...
        "scoreboard_description": "跟踪并显示各种目标的分数",
        ...
        "tellraw_error_withNotArray": "原始文本中的“with”域必须包含一个数组。示例：\"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
        ...
        "videostream_description": "尝试连接到 WebSocket 服务器以发送视频流。",
        "videostreamaction_description": "执行与视频流相关的操作。",
