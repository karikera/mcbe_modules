...
commands:{
    ...
    "scoreboard_description": "Sledujte a zobrazujte skóre pre rôzne ciele",
    ...
    "tellraw_error_withNotArray": "Pole with v objekte rawtext musí obsahovať pole. Príklad: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Pokúsi sa pripojiť na server WebSocket a odoslať obrazový prúd údajov.",
    "videostreamaction_description": "Vykonať akciu súvisiacu s obrazovým prúdom údajov.",
