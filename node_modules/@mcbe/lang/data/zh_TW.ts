...
commands:{
    ...
    "code_description": "執行 Code Builder。",
    "code_success": "已執行 Code Builder。",
    ...
    "scoreboard_description": "追蹤和顯示多個物件的分數",
    ...
    "tellraw_error_withNotArray": "Rawtext 中的「with」欄位必須包含陣列。範例：\"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "嘗試連線到 Websocket 伺服器以傳送影片串流。",
    "videostreamaction_description": "執行影片串流相關操作。",
    "weather_clear": "變更為晴天",
