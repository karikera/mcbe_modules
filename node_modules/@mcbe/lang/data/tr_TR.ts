...
commands:{
    ...
    "code_description": "Code Builder'ı başlatır.",
    "code_success": "Code Builder başlatıldı.",
    ...
    "scoreboard_description": "Çeşitli hedefler için puanları izle ve göster",
    ...
    "tellraw_error_withNotArray": "rawtext içindeki with alanı bir dizi içermelidir. Örnek: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Bir video akışı göndermek üzere websocket sunucusuna bağlanmayı dener.",
    "videostreamaction_description": "Video akışı ile ilgili bir eylem gerçekleştirir.",
