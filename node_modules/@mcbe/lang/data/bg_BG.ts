...
const lang_data = {
    ...
    commands:{
        ...
        "scoreboard_description": "Проследяване и показване на резултати за различни цели",
        ...
        "tellraw_error_withNotArray": "полето „със“ в rawtext трябва да съдържа масив. Пример: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
        ...
        "videostream_description": "Извършва опит за свързване към сървъра websocket за изпращане на видео поточно предаване.",
        "videostreamaction_description": "Изпълнява действие, свързано с видео поточно предаване.",
