...
commands:{
    ...
    "scoreboard_description": "Відстежуйте й показуйте очки для різних цілей",
    ...
    "tellraw_error_withNotArray": "з полем в об’єкті rawtext має містити масив. Приклад: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Намагається підключитися до сервера веб-сокета, щоб транслювати відеопотік.",
    "videostreamaction_description": "Виконати дію з відеопотоком.",
