...
commands:{
    ...
    "scoreboard_description": "Spara och visa resultat för diverse uppgifter",
    ...
    "tellraw_error_withNotArray": "Medfältet i råtext måste innehålla en matris. Exempel: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Försöker att ansluta till Websocket-servern för att skicka en videostream.",
    "videostreamaction_description": "Utför en åtgärd relaterad till en videostream.",
