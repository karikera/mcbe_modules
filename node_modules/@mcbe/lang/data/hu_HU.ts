...
const lang_data = {
    ...
    commands:{
        ...
        "scoreboard_description": "Különféle feladatok pontszámának nyomon követése és kijelzése",
        ...
        "tellraw_error_withNotArray": "a rawtext with mezőjének tartalmaznia kell egy tömböt. Példa: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
        ...
        "videostream_description": "Csatlakozási kísérlet a hálózati kiszolgálóhoz videoközvetítés küldéséhez.",
        "videostreamaction_description": "Videoközvetítéssel kapcsolatos akció végrehajtása.",
