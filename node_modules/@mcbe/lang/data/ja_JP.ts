...
const lang_data = {
    ...
    commands:{
        ...
        "code_description": "Code Builder を起動します。",
        "code_success": "Code Builder を起動しました。",
        ...
        "tellraw_error_withNotArray": "rawtext の with フィールドには、配列を含める必要があります。例: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
        ...
        "videostream_description": "WebSocket サーバーに接続し、ビデオ ストリームの送信を試みます。",
        "videostreamaction_description": "ビデオ ストリームに関連する操作を実行します。",
