...
commands:{
    ...
    "code_description": "Käynnistää Code Builderin.",
    "code_success": "Code Builder käynnistetty.",
    ...
    "scoreboard_description": "Seuraa ja katso eri tavoitteiden pistetilanteita",
    ...
    "tellraw_error_withNotArray": "jossa on rawtext-kenttä, on sisällettävä taulukko. Esimerkki: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Yrittää yhdistää websocket-palvelimeen videon suoratoistoa varten.",
    "videostreamaction_description": "Suorita suoratoistoon liittyvä toiminto.",
