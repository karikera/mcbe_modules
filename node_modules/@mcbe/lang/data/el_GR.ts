...
commands:{
    ...
    "scoreboard_description": "Παρακολούθηση και εμφάνιση βαθμολογίας για διάφορους στόχους",
    ...
    "tellraw_error_withNotArray": "Το πεδίο \"with\" (με) στο rawtext πρέπει να περιέχει συστοιχία. Παράδειγμα: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Επιχειρεί σύνδεση με τον διακομιστή websocket για αποστολή μιας ροής βίντεο.",
    "videostreamaction_description": "Κάνε μια ενέργεια που σχετίζεται με ροή βίντεο.",
