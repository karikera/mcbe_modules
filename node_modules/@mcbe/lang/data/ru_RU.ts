...
const lang_data = {
    ...
    commands:{
        ...
        "code_description": "Запускает Создателя кода.",
        "code_success": "Запущен Создатель кода.",
        ...
        "scoreboard_description": "Отслеживайте и показывайте баллы для разных целей",
        ...
        "tellraw_error_withNotArray": "с полем в объекте rawtext должен содержать массив. Пример: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
        ...
        "videostream_description": "Пытается подключиться к серверу веб-сокета, чтобы транслировать видеопоток.",
        "videostreamaction_description": "Выполнить действие с видеопотоком.",
