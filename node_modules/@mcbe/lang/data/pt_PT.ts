...
const lang_data = {
    ...
    commands:{
        ...
        "tellraw_error_withNotArray": "o campo com em texto não processado tem de conter uma matriz. Exemplo: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
        ...
        "videostream_description": "Tentativas para ligar ao servidor websocket para enviar uma transmissão de vídeo.",
        "videostreamaction_description": "Executar uma ação relacionada com uma transmissão de vídeo.",
    ...
    item:{
        ...
        "cobblestone_wall": [
            "Muro de Pedra Arredondada",
            "Muro de Pedra Arredondada",
            "Muro de Pedra Arredondada com Musgo",
            "Muro de Granito",
            "Muro de Diorito",
            "Muro de Andesito",
            "Muro de Arenito",
            "Muro de Tijolo",
            "Muro de Tijolo de Pedra",
            "Muro de Tijolo de Pedra com Musgo",
            "Muro de Tijolo de Pedra do Fim",
            "Muro de Tijolo do Submundo",
            "Muro de Prismarine",
            "Muro de Arenito Vermelho",
            "Muro de Tijolo Vermelho do Submundo"
        ],
        "cocoa": [
            "Cacau"
        ],
