...
commands:{
    ...
    "scoreboard_description": "Følg med på og vis resultater for ulike mål",
    ...
    "tellraw_error_withNotArray": "with-feltet i rawtext må inneholde en matrise. Eksempel: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
    ...
    "videostream_description": "Prøver å koble til WebSocket-serveren for å sende en videostrøm.",
    "videostreamaction_description": "Utfør en videostrømrelatert handling.",
