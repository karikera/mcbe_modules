...
export const lang_data = {
    ...
    "ko_KR": {
        "commands": {
            ...
            "blockdata_notValid": "타겟 블록이 데이터 홀더 블록이 아닙니다",
            ...
            "code_description": "코드 작성기를 실행합니다.",
            "code_success": "코드 작성기를 실행했습니다.",
            ...
            "tellraw_error_withNotArray": "원본 텍스트의 with 필드는 배열을 포함해야 합니다. 예제: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]",
            ...
            "videostream_description": "비디오 스트림을 전송하기 위해 웹 소켓 서버에 연결을 시도합니다.",
            "videostreamaction_description": "비디오 스트림 관련 작업을 수행하세요.",
