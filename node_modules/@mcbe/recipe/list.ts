...
export const recipes = new Map([
    ...
    [ID.netherite_helmet,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_helmet, 1],],[[ID.netherite_helmet, 1],])
    ]],
    [ID.netherite_chestplate,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_chestplate, 1],],[[ID.netherite_chestplate, 1],])
    ]],
    [ID.netherite_leggings,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_leggings, 1],],[[ID.netherite_leggings, 1],])
    ]],
    [ID.netherite_boots,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_boots, 1],],[[ID.netherite_boots, 1],])
    ]],
    [ID.netherite_axe,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_axe, 1],],[[ID.netherite_axe, 1],])
    ]],
    [ID.netherite_hoe,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_hoe, 1],],[[ID.netherite_hoe, 1],])
    ]],
    [ID.netherite_pickaxe,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_pickaxe, 1],],[[ID.netherite_pickaxe, 1],])
    ]],
    [ID.netherite_shovel,[
        new Recipe([ID.smithing_table],[[ID.nether_ingot, 1],[ID.diamond_shovel, 1],],[[ID.netherite_shovel, 1],])
    ]],
