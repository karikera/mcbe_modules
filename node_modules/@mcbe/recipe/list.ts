...
export const recipes = new Map([
    ...
    [ID.campfire,[
        new Recipe([ID.crafting_table],[[ID.stick, 3],[ID.log, 3],[ID.coal, 1],],[[ID.campfire, 1],]),
    ...
    [ID.tnt,[
        new Recipe([ID.crafting_table],[[ID.sand, 4],[ID.gunpowder, 5],],[[ID.tnt, 1],])
    ]],
    [ID.suspicious_stew,[
    ...
    [ID.stone,[
        new Recipe([ID.furnace],[[ID.cobblestone, 1],],[[ID.stone, 1],]),
    ...
    [ID.prismarine,[
        ...
        new Recipe([ID.crafting_table],[[ID.prismarine_shard, 9],],[[ID.prismarine, 1],])
    ]],
    [ID.detector_rail,[
    ...
    [ID.glass_bottle,[
        new Recipe([],[[ID.honey_bottle, 1],],[[ID.glass_bottle, 1],[ID.sugar, 3],]),
        new Recipe([],[[ID.honey_bottle, 4],],[[ID.glass_bottle, 4],[ID.honey_block, 1],]),
    ...
    [ID.honey_bottle,[
        new Recipe([],[[ID.honey_block, 1],[ID.glass_bottle, 4],],[[ID.honey_bottle, 4],])
    ]],
]);
