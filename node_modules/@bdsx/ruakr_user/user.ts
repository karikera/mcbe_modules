...
import { Actor, NetworkIdentifier } from "bdsx";
...
const extraEvents:Events = {
    onNew: new UserEvent<()=>void>(),
    onFirstLogin: new UserEvent<()=>void>(),
    onMoveStart: new UserEvent<()=>void>(),
    onDeath: new UserEvent<()=>void>(),
    onUpdateReal: new UserEvent<()=>void>(),
    onUpdateRealEnd: new UserEvent<()=>void>(),
    onUpdateSlow: new UserEvent<()=>void>(),
    onPlaceBefore: new UserEvent<(block:Block)=>boolean>(),
    onPlace: new UserEvent<(block:Block, hand:Identifier)=>boolean>(),
    onAttack: new UserEvent<(ev:AttackEvent)=>void>(),
    onInterect: new UserEvent<(block:Block)=>boolean>(),
    onInterectEnd: new UserEvent<(block:Block)=>void>(),
    onDestroyStart: new UserEvent<(block:Block)=>void>(),
    onDestroy: new UserEvent<(block:Block)=>void>(),
    onDispose: new UserEvent<()=>void>(),
    onItemChange: new UserEvent<(now:Identifier, prev:Identifier, nowCount:number, prevCount:number)=>void>(),
    onUseItem: new UserEvent<(method:UseMethod, item:Identifier, count:number)=>void>(),
    onAcquireItem: new UserEvent<(method:AcquationMethod, item:Identifier, count:number, secondary_entity?:IEntity)=>void>(),
    onTakeItem: new UserEvent<(item:Identifier, count:number)=>void>(),
    onGiveItem: new UserEvent<(item:Identifier, count:number)=>void>(),
    onDropItem: new UserEvent<(item:Identifier, count:number)=>void>(),
};
...
const NULL_POSITION = new Position(0, -1, 0, DimensionId.Overworld);
...
export class User implements UserLike
{
    ...
    private loggedPosition:Position = NULL_POSITION;
