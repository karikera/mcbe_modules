...
const lang_data = {
    ...
    commands:{
        ...
        "function_invalidCharacters": "Function with title '%s' is invalid, the character '%s' is not allowed in function names.",
        "function_noEngineVersionSpecified": "Function %s could not be run. You must specify a min_engine_version in the behaviour pack's manifest.json.",
        ...
        "kick_no_host": "The host may not be kicked out of the game.",
        ...
        "mixer_stop_success": "Mixer interactive has stopped.",
        ...
        "reload_description": "Reloads all function files from all behaviour packs.",
        ...
        "scoreboard_objectives_add_displayTooLong": "The display name '%1$s' is too long for an objective, it can be a maximum of %2$d characters long",
        "scoreboard_objectives_add_success": "Added a new objective '%1$s' successfully",
        "scoreboard_objectives_add_tooLong": "The name '%1$s' is too long for an objective, it can be a maximum of %2$d characters long",
        ...
        "scoreboard_players_test_success": "Score %1$d is in the range %2$d to %3$d",
        ...
        "scoreboard_teams_add_displayTooLong": "The display name '%1$s' is too long for a team, it can be a maximum of %2$d characters long",
        "scoreboard_teams_add_success": "Added new team '%1$s' successfully",
        "scoreboard_teams_add_tooLong": "The name '%1$s' is too long for a team, it can be a maximum of %2$d characters long",
        "scoreboard_teams_empty_alreadyEmpty": "Team %1$s is already empty, cannot remove non-existent players",
        ...
        "tellraw_error_withNotArrayOrRawText": "with field in rawtext, must contain an array or another rawtext object. Example 1: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\": [ \"value1\", \"value2\" ]}]  Example 2: \"rawtext\":[{\"translate\": \"chat.type.announcement\", \"with\":{\"rawtext\":[{\"text\": \"value1\"}, {\"text\": \"value2\"}]}}]",
        ...
        "tickingarea_add_circle_success": "Added ticking area centred at %1$d with a radius of %2$d chunks.",
        ...
        "worldborder_center_success": "Set world border centre to %1$s,%2$s",
    ...
    item:{
        ...
        "monster_egg": [
            ...
            "Infested Chiselled Stone Brick"
        ],
        "mushroom": [
            "Mushroom"
        ],
